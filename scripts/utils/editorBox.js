...
define(function () {
    ...
    var Editor = new Class({
        ...
        Addtable: function () {
            ...
            if (!this.tablepopup) {
                ...
                this.tablepopup.pos();
                $$(this.tablepopup.container, "div")[1].innerHTML = "<div style='margin-left:30px; margin-top:7px;'>行数：<input style='width:50px;height:20px;display:inline;border:solid rgb(182, 178, 178) 1px;'  type='text' />　列数：<input style='width:50px;height:20px;display:inline;border:solid rgb(182, 178, 178) 1px;'  type='text' /></div><div style=' margin-left:30px; margin-top:7px;'>表格的宽度：<input style='width:50px;height:20px;display:inline;border:solid rgb(182, 178, 178) 1px;'  type='text' /> px</div><div style=' margin-left:30px; margin-top:7px;'>表行的高度：<input style='width:50px;height:20px;display:inline;border:solid rgb(182, 178, 178) 1px;'  type='text' /> px<div style='text-align:center; margin-left:30px; margin-top:7px;'><img src='http://album.hi.csdn.net/app_uploads/wtcsy/20090719/220836549.p.gif'>　<img src='http://album.hi.csdn.net/app_uploads/wtcsy/20090719/220726721.p.gif'></div>"
    ...
    var popoup = new Class({
        ...
        pos: function () {
            var left = (Math.max(document.documentElement.scrollWidth, document.documentElement.clientWidth) - this.w) / 2;
            var top = ((Math.min(document.documentElement.scrollHeight, document.documentElement.clientHeight) - this.h) / 2 + document.documentElement.scrollTop);
