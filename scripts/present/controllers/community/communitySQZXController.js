...
define(['baseControllers'], function (baseControllers) {
    baseControllers.controller('communitySQZXController', function (
        ...
        $scope.chooseShop = function () {
            $$chooseService.show({
                ...
                completeCallback: function (dataArr) {
                    ...
                    //获取详情
                    $$dataBase.getData('BackendCommunitySQZXGet', {
        ...
        $scope.modify = function () {
            ...
            postContent.modifyType = appConfig.EShelfType.SQZX;
        ...
        $scope.delete = function (targetObjectId) {
            $$confirmModal('是否删除当前货架？').then(function () {
                var postContent = {
                    ...
                    modifyType: appConfig.EShelfType.SQZX
                };
