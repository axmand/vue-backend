...
define(['baseControllers'], function (baseControllers) {
    baseControllers.controller('communitySQRCController', function (
        ...
        $scope.modify = function () {
            ...
            postContent.modifyType = appConfig.EShelfType.SQRC;
        ...
        $scope.delete = function (targetObjectId) {
            $$confirmModal('是否删除当前货架？').then(function () {
                var postContent = {
                    ...
                    modifyType: appConfig.EShelfType.SQRC
                };
        ...
        $scope.shelfPost = function () {
            var postContent = {
                ...
                eShelfType: appConfig.EShelfType.SQRC,
