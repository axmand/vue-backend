define(['baseControllers'], function (controllers) {
    controllers.controller('cargoDetailController', ['$scope', '$$dataBase', '$stateParams', '$ionicModal', '$$chooseShopService', '$$cutPictureService', '$$dataCache', '$$toast', '$window', '$$bootstrapModal',
    function ($scope, $$dataBase, $stateParams, $ionicModal, $$chooseShopService, $$cutPictureService, $$dataCache, $$toast, $window, $$bootstrapModal) {
