...
define(['baseServices'], function (services) {
    ...
    services.service('$$dataBase', ['$$commonDatabase', '$$storageDatabase', '$q', function ($$commonDatabase, $$storageDatabase, $q) {
        angular.extend(this, $$commonDatabase, $$storageDatabase);
        //Opts的结构
        /*
        opts={
          url:'',
