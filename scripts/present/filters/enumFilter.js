define(['baseFilters', 'objutil'], function (baseFilters, objutil) {
    ...
    baseFilters.filter('$$enumFilter', function () {
        //店铺类型
        var typeShops = {
            '餐饮/美食': 'cyms',
            'cyms': '餐饮/美食',
        ...
        //
        var typeECategory = {
            CommercialCargo: '商品分类',
            CommercialMarketCity: '城市分类',
            CommercialMerchant: '店铺角色分类(代理/供应)',
            CommercialShop: '店铺经营类型分类',
            CommercialVideo: '商城视频分类',
            CommercialWhareHouse: '仓库类',
            ConvenienceJourneyman: '便民工匠分类',
            ConverienceMessage: '便民消息分类',
            ConverienceVideo: '便民视频分类',
            CommercialWaybill: '物流公司分类',
        }
        //总字典
        var dictionary = {};
